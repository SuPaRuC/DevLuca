<footer id="contacts" class="py-20 sm:py-32 border-t border-solid border-violet-950 flex flex-col gap-4 sm:gap-8 justify-center items-center">
    <p class="px-4 py-2 bg-white text-slate-950 font-medium rounded-lg">
        Connect with me <i class="fa-solid fa-arrow-down ml-1 text-base"></i>
    </p>
